## Description
### This game is a refactored version [Here's the original](https://github.com/leov2000/IS211_Assignment7). This version includes the option to play with a timer of 1 min and an option to play against a computer. The game ends when a player reaches 100 points or the timer reaches 1 min.
